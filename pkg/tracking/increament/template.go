...
const TemplateForMainEntry = `// +goat: generated by increament tracking package, do not edit
{{.PackageName}}.ServeHTTP(COMPONENT_{{ .ID }})
`

func MainEntryInit(ident string, componentID int) []string {
	return []string{
		"// +goat: generated by increament tracking package, do not edit.",
		fmt.Sprintf("%s.ServeHTTP(COMPONENT_%d)", ident, componentID),
	}
}
